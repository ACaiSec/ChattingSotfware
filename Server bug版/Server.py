...
=======
        self.usr_online = [['xx', ('127.0.0.2', 10149), 'xxasd'], ['gx', ('127.0.0.3', 10150), 'xasfeefdfdf'], ['abcd', ('127.4.5.6', 12345), 'sasasa']]
        self.addr_port = ('127.0.0.1', 10148)
>>>>>>> bug bug bubug
...
=======
    ...
    def sendCheck(self,UDP_socket):
        while True:
            time.sleep(20)
            middle = self.usr_online
            # threading.Thread(target=self.timeclock(UDP_socket)).start()
            for each in middle:
>>>>>>> bug bug bubug
                print(each)
